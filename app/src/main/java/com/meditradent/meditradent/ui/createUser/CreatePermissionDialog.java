...
public class CreatePermissionDialog extends AlertDialog {

    private DialogGetPermissionBinding binding;
    private Context context;
    private OnClickGetPermission listener;

    public CreatePermissionDialog(Context context , OnClickGetPermission listener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.title.setText(context.getString(R.string.permission_create));
