...
import com.toothbrush.smarttoothbrush.databinding.ActivityMainBinding;
...
//            data.addEntry(new Entry(set.getEntryCount(), (float) (Math.random() * 80) + 10f), 0);
                data.addEntry(new Entry(mChart.getLineData().getEntryCount(), event.values[0] ), 0);
    ...
    protected void onDestroy() {
        mSensorManager.unregisterListener(ChartActivity.this);
        thread.interrupt();
        super.onDestroy();
    }
